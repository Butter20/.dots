# aur
alias pa='pacaur'
alias pay='pacaur -y --rebuild'
alias pas='pacaur -Ss'
alias pasi='pacaur -s --ignore-ood'
alias passn='pacaur -s --sort name'
alias passv='pacaur -s --sort votes'
alias passp='pacaur -s --sort popularity'
alias pau='pacaur upgrades'
alias pasy='pacaur -S --rebuild'
alias paud='pacaur -ud'
alias pak='pacaur -k'
alias pam='pacaur -m'
alias pasc='pacaur -Sc'
...
alias pbld='cd $HOME/.cache/pacaur'
...
alias 3d='cd /mnt/photo/3D'
alias 2d='cd /mnt/photo/2D'
alias zippy='cd $HOME/func/zippyshare'
alias ova='cd /mnt/OVA'
alias jav='cd /mnt/JAV'
...
# stow
alias stow_lxqt='stow -t ~/.config/lxqt lxqt --override=.log'
