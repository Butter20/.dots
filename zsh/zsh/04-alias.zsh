...
alias startgu='sudo ip link set wlp2s0 up && sudo wpa_supplicant -B -i wlp2s0 -c /etc/wpa_supplicant/guate.conf && sudo dhcpcd wlp2s0 && sudo hdparm -B 255 -S 0 /dev/sda'
