...
alias startgt='sudo ip link set wlp2s0 up && sudo wpa_supplicant -B -i wlp2s0 -c /etc/wpa_supplicant/wpa_supplicant-gt.conf && sudo dhcpcd wlp2s0'
alias starthuawei='sudo ip link set wlp2s0 up && sudo wpa_supplicant -B -i wlp2s0 -c /etc/wpa_supplicant/wpa_supplicant-huawei.conf && sudo dhcpcd wlp2s0'
alias startmex='sudo ip link set wlp2s0 up && sudo wpa_supplicant -B -i wlp2s0 -c /etc/wpa_supplicant/wpa_supplicant-mex.conf && sudo dhcpcd wlp2s0'
